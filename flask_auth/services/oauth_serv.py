...
class OauthServ:
    ...
    def check_and_create_account(cls, oauth_app: FlaskOAuth2App) -> tuple[Response, HTTP]:
        ...
        The whole move is based on the uniqueness of the email, as well as the calculation,
        If you have an email in the social network, it was validated and a user
        confirmed it.'''
